...
protected:
	ClassT() : Class(typeid(Class).name())
	{
		...
		m_Methods.push_back(Method{.Name = "getField", .Type = "|"+Class::Get<String>()->getName()+"|"+Class::Get<Field &>()->getName()+"", .Return = "bool", .Access = ::New<FuncT<bool,Raw<T>,String,Field & >>([](Raw<T> _0,String _1,Field & _2)->bool { return _0->getField(_1,_2); }), });
		m_Methods.push_back(Method{.Name = "getMethod", .Type = "|"+Class::Get<String>()->getName()+"|"+Class::Get<Method &>()->getName()+"", .Return = "bool", .Access = ::New<FuncT<bool,Raw<T>,String,Method & >>([](Raw<T> _0,String _1,Method & _2)->bool { return _0->getMethod(_1,_2); }), });
		...
		m_Methods.push_back(Method{.Name = "getSField", .Type = "|"+Class::Get<String>()->getName()+"|"+Class::Get<Field &>()->getName()+"", .Return = "bool", .Access = ::New<FuncT<bool,Raw<T>,String,Field & >>([](Raw<T> _0,String _1,Field & _2)->bool { return _0->getSField(_1,_2); }), });
		m_Methods.push_back(Method{.Name = "getSMethod", .Type = "|"+Class::Get<String>()->getName()+"|"+Class::Get<Method &>()->getName()+"", .Return = "bool", .Access = ::New<FuncT<bool,Raw<T>,String,Method & >>([](Raw<T> _0,String _1,Method & _2)->bool { return _0->getSMethod(_1,_2); }), });
	}
};
