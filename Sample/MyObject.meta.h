...
protected:
    ClassT() : Class("MyObject")
    {
		...
		m_Methods.push_back(Method{.Name = "Foo", .Type = "[String,float]", .Access = ::New<CallT<void,Raw<T>,String,float>>([](Raw<T> _0,String _1,float _2) { return _0->Foo(_1,_2); }), } );
		m_Methods.push_back(Method{.Name = "Foo2", .Type = "[String,float]", .Access = ::New<CallT<void,Raw<T>,String,float>>([](Raw<T> _0,String _1,float _2) { return _0->Foo2(_1,_2); }), } );
		...
		m_SMethods.push_back(Method{.Name = "SFoo", .Type = "[String,float]", .Access = ::New<CallT<void,String,float>>([](String _1,float _2) { return T::SFoo(_1,_2); }), } );
		m_SMethods.push_back(Method{.Name = "SFoo2", .Type = "[String,float]", .Access = ::New<CallT<void,String,float>>([](String _1,float _2) { return T::SFoo2(_1,_2); }), } );
