...
//         m_Methods.push_back(Method{.Name = "Foo", .Type = "(String)", .Access = ::New<CallT<void, Raw<T>, String>>([](auto _0, auto _1) { return _0->Foo(_1); }),});
//
//         m_SFields.push_back(Field{.Name = "SName", .Type = "String", .Access = ::New<CallT<Raw<String>>>([]() { return &T::SName; }),});
//         m_SMethods.push_back(Method{ .Name = "SFoo", .Type = "(String)", .Access = ::New<CallT<void, String>>([](auto _0) { return T::SFoo(_0); }), });
//     }
//
